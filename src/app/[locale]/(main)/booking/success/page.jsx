...
export default function BookingSuccessPage({ params }) {
  ...
  useEffect(() => {
    const fetchBooking = async () => {
      try {
        // const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/bookings/${params.id}`);
        // const data = await res.json();
        
        // MOCK DATA for demonstration
        setTimeout(() => {
          setBooking({
            reference: params.id || "NK-8293XJ",
            property_name: "Tribal Bistro Touba",
            checkin: "Jan 04, 2026",
            is_guest: true, // <--- Toggle this to test Guest View
      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="text-center space-y-4 animate-fade-in-up">
          <div className="relative inline-flex items-center justify-center">
            ...
            {/* Decoration particles could go here */}
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden animate-slide-up">
          ...
          <div className="p-6 grid grid-cols-2 gap-4 border-b border-slate-100 border-dashed">
            <div>
              <p className="text-xs text-slate-400 font-bold uppercase mb-1">Property</p>
            ...
            <div className="p-6 bg-blue-50/50">
              <div className="bg-white border border-blue-100 rounded-xl p-5 shadow-sm relative overflow-hidden">
                ...
                <div className="flex items-start gap-4 relative z-10">
                  ...
                  <div>
                    {/* FIXED: Don't -> Don&apos;t (Also fixed 'loss' to 'lose' for grammar) */}
